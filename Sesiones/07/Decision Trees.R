...
credit <- read.csv("https://raw.githubusercontent.com/PacktPublishing/Machine-Learning-with-R-Fourth-Edition/main/Chapter%2005/credit.csv", stringsAsFactors = TRUE)
str(credit)
...
## Step 2: Exploring and preparing the data ---- 
mushrooms <- read.csv("https://raw.githubusercontent.com/PacktPublishing/Machine-Learning-with-R-Fourth-Edition/main/Chapter%2005/mushrooms.csv", stringsAsFactors = TRUE)
