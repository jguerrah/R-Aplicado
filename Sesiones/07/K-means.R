...
teens <- read.csv("https://raw.githubusercontent.com/PacktPublishing/Machine-Learning-with-R-Fourth-Edition/main/Chapter%2009/snsdata.csv", stringsAsFactors = TRUE)
str(teens)
